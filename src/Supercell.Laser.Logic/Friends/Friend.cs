    ...
    public class Friend
    {
        ...
        public void Encode(ByteStream stream)
        {
            ...
            if (stream.WriteBoolean(DisplayData != null))
            {
                ...
                //DisplayData.ThumbnailId = HomeMode.Home.ThumbnailId;
                //DisplayData.NameColorId = HomeMode.Home.NameColorId;
                //DisplayData.HighNameColorId = 0 ? DisplayData.NameColorId : 0
